...
class AI(Player):
        ...
        def get_random_neighbor(self):
            ...
            neighbors = []
            for target in self.previous_targets:
                near = [
                     (-1, 0),
                    (0, -1), (0, 1),
                     (1, 0)
                ...
                for dx, dy in near:
                    cur = Dot(target.x + dx, target.y + dy)
                    if not self.board.out(cur) and cur not in self.previous_targets:
...
class Game:
    ...
    def loop(self):
        ...
        while True:
            ...
            for i, j in zip(str(self.us.board).split('\n'), str(self.ai.board).split('\n')):
                print(i + "      |    " + j)
            print("-" * 20)
